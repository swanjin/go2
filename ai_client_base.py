...
class AiClientBase:
    ...
    def response_format_auto(self):
        ...
        - **Reason**: 
          - If neither {self.env['object1']}, {self.env['object2']}, {self.env['object3']}, nor {self.env['object4']} is detected, never metion any of them but include a sentece which has a similar meaning to 'I looked around, but I don't see an apple, so I'm rotating to explore a different orientation.' in your reasoning.
