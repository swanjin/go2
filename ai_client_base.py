...
class AiClientBase:
    ...
    def user_prompt_feedback(self, curr_state):
        ...
        (1,-6),(-4,4),(-2,4),(-1,4),(4,-4),(3,-6),(4,2),(-5,-4),(-5,2),(2,4),
        (0,4),(-4,-6),(-2,-6),(-1,-6),(4,-5),(4,-2),(-5,-5),(4,-1),(4,1),
        (-5,-2),(-5,-1),(4,4),(-5,1),(-3,4),(-5,4),(0,-6),(2,-6),(1,4),(-1,0)

        Landmarks:
        "refrigerator":(4,4,180),"kitchen":(0,4,180),"TV":(-5,-1,90),
        "desk":(-3,-6,0),"cabinet":(0,-6,0),"sofa":(4,-3,270),
        banana":(2,4,180),"bottle":(4,0,270)
        """
        )
    ...
    def response_format_auto(self):
        ...
        Current state: compute '(x, y, orientation)' before you take any action at this round.
        Target visibilty: If the target is detected in the 'Image Analysis' section, mark 'Visible'; otherwise, 'Invisible.'
        ...
        New state: Follow the guideline in the '### Instructions for New state (sx, y, orientation)' section.
        Reason: 
...
class ResponseMessage:
    ...
    def parse(message: str):
        try:
            ...
            curr_state, target, likelihood, action, move, shift, turn, new_state, reason = parts
        ...
        return ResponseMessage(curr_state, target, likelihood, action, move, shift, turn, new_state, reason)
